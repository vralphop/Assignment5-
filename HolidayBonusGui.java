...
public class HolidayBonusGui extends Application {
	...
	public void readFile() throws FileNotFoundException {
		...
		double highBonus = 100.0;
		double lowBonus = 50.0;
		double otherBonus = 25.0;

		double[] result = HolidayBonus.calculateHolidayBonus(sales, highBonus, lowBonus, otherBonus);
		...
		// display total of holiday bonuses
		 ...
		 double bonus = HolidayBonus.calculateTotalHolidayBonus(sales, highBonus, lowBonus, otherBonus);
